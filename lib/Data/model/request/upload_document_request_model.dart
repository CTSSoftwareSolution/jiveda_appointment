...
class UploadDocumentRequestModel {
  ...
  UploadDocumentRequestModel.fromJson(dynamic json) {
  ...
  String? _patientID;
  List<Files>? _files;
UploadDocumentRequestModel copyWith({  String? tokenID,
  String? patientID,
  List<Files>? files,
}) => UploadDocumentRequestModel(  tokenID: tokenID ?? _tokenID,
...
Files copyWith({  String? fileName,
  String? fileExtension,
  String? filePath,
}) => Files(  fileName: fileName ?? _fileName,
